...
import ArijitGhosh from "../public/ArijitGhosh.webp";
import Devain from "../public/Devain.webp";
import ArshdeepRooprai from "../public/ArshdeepRooprai.webp";
import Harshit from "../public/Harshit.webp";
  ...
  const developers = [
    {
      ...
      image: Devain,
      github: "https://github.com/yensen-arch",
    ...
    },
    {
      ...
      role: "Full Stack Developer",
      image: Harshit,
      github: "https://github.com/Harshit-1874",
      linkedin: "https://www.linkedin.com/in/haggarwal505",
      mail: "haggarwal505@gmail.com",
    },
    {
      name: "ARIJIT GHOSH",
      role: "Backend Developer",
      image: ArijitGhosh,
      github: "https://www.github.com/ghoshariji",
      linkedin:
  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-8 lg:px-12">
      <h2 className="text-4xl font-extrabold text-center mb-8 bg-gradient-to-r from-slate-200 via-blue-400 to-black bg-clip-text text-transparent relative">
        ...
        <span className="block m-b-6 h-1 mx-auto mt-2 bg-gradient-to-r from-white via-blue-500 to-black animate-pulse transition-all duration-500 ease-in-out"></span>
      </h2>
